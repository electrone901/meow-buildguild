...
function SelectCat() {
  const { catSelected, setCatSelected } = useContext(MyContext);
  ...
  const data = [
    { front: "/assets/cat 001.png", back: "/assets/1.png", name: "Jessie" },
    { front: "/assets/cat 002.png", back: "/assets/2.png", name: "Marshmallow" },
    { front: "/assets/cat 003.png", back: "/assets/3.png", name: "Mousie" },
  ];
  ...
  const setImage = async () => {
    setCatSelected(data[selectedImage]);
            ...
            <div className="relative">
              <Image
                ...
                className={`object-cover rounded-md  border-8 border-white ${
                  selectedImage === index ? `w-[320px] h-[420px]` : `w-[300px] h-[400px]`
